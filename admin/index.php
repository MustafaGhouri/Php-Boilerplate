<?php
require '../config.php';
require($_SERVER['DOCUMENT_ROOT'].$site_dir . '/include/connection.php');

if (isset($globaluserid)) {
    $rootDir = $url . 'admin/dashboard/';
    echo '<script>window.open("' . $rootDir . '", "_self");</script>';
    exit();
}
...
<head>
    ...
    <title>Portal | <?= $settinginfo['website_name'] ?></title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Welcome to GCS Portal</h1>
                        <p class="">Log in to your account to continue.</p>

                        <form class="text-left" id='login'>
                            <div id="alert"></div>
                            <div class="form">
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary btn-sbmit" value="">Log In</button>
                                    </div>
                                </div>
                            </div>
                        </form>
